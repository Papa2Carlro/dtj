...
exports.initialExplorerState = initialExplorerState;
const constants_1 = require("./constants");
/** Build CSP-safe webview HTML. Script is inline with nonce; no external network. */
function renderWebviewHtml(nonce, cspSource) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
...
function initialExplorerState(partial) {
    return {
        phase: "loading",
        stale: false,
        tornTail: false,
        ...
        queryText: constants_1.DEFAULT_TRACEQL_QUERY,
        ...partial,
    };
}
