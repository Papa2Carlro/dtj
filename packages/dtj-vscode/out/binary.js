...
exports.resolveDtjBinaryPath = resolveDtjBinaryPath;
const fs = __importStar(require("node:fs"));
const path = __importStar(require("node:path"));
const constants_1 = require("./constants");
function resolveDtjBinaryPath(configured, opts) {
    ...
    if (!raw) {
        return {
            ...
            message: `Set absolute setting ${constants_1.BINARY_SETTING} to a prebuilt dtj binary`,
        };
    }
